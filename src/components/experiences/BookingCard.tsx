  ...
  return (
    <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 border border-[#1c315e]/5 space-y-6">
      <div className="flex items-baseline justify-between">
        <span className="text-[#1c315e]/60 font-bold uppercase tracking-widest text-[10px]">Price per person</span>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
           <label className="text-[10px] font-black text-[#1c315e]/60 uppercase tracking-widest ml-1">Select Date</label>
           <Popover>
        ...
        {/* Guest Selector */}
        <div className="space-y-2">
            <label className="text-[10px] font-black text-[#1c315e]/60 uppercase tracking-widest ml-1">Number of Guests</label>
      ...
      <div className="border-t-2 border-dashed border-[#1c315e]/10 pt-6 space-y-4">
        <div className="flex justify-between items-center">
            <span className="text-[#1c315e] font-black uppercase tracking-widest text-[11px]">Total Estimate</span>
        ...
        <p className="text-[10px] text-center text-muted-foreground font-bold">Free cancellation up to 48 hours before</p>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-xl border-t md:hidden z-50 flex items-center justify-between gap-4">
        <div>
            ...
            <div className="text-[10px] font-bold text-muted-foreground uppercase">{guests} {guests === 1 ? 'Guest' : 'Guests'}</div>
        </div>
