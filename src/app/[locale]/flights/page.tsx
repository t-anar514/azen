...
export const metadata = {
  ...
  description: "Япон руу хямд нислэгийн саналуудыг харьцуулж, аэропортын хүргэлтээ нэг дор захиалаарай.",
}
...
export default async function FlightsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#e6e2c3] pb-20">
      <section className="px-4 pt-16 pb-10 text-center">
        ...
        <h1 className="mt-4 text-4xl font-black text-[#1c315e] md:text-5xl">Японд хямд нисье</h1>
